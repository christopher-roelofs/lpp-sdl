...
#include "src/include/InterVariable_font.h"
#include <SDL_ttf.h>
#include <string>
#include <unistd.h>
#include <vector>
...
int main(int argc, char* args[]) {
    ...
    // Load the global default font from embedded data
    g_defaultFont = TTF_OpenFontRW(SDL_RWFromConstMem(InterVariable_ttf, InterVariable_ttf_len), 1, 16); // Default size 16
    if (!g_defaultFont) {
        printf("Warning: Failed to load embedded default font. Graphics.print will not work. TTF_Error: %s\n", TTF_GetError());
