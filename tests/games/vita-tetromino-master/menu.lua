...
-- load background
local img_background 	= Graphics.loadImage("assets/img/bg.png")
local img_version 		= Graphics.loadImage("assets/img/version.png")
local img_menu 			= Graphics.loadImage("assets/img/menu.png")
local img_touch			= Graphics.loadImage("assets/img/touch_negative.png")
local img_pointer 		= Graphics.loadImage("assets/img/pointer.png")
