...
-- load battery
local img_battery_icon 	= Graphics.loadImage("assets/img/power.png")

-- font
local fnt_main = Font.load("assets/fonts/xolonium.ttf")

-- static file locations
local config_file = "data/tetrinomi/tetromino.conf"
...
function get_high_score(mode)
	...
	-- check if file exist
	if System.doesFileExist("data/tetrinomi/tetromino.score") then
		...
		-- score file
		local score_file = System.openFile("data/tetrinomi/tetromino.score", FREAD)
...
function write_score(mode, value, player, playtime, stats)
	...
	score_file = System.openFile("data/tetrinomi/tetromino.score", FCREATE)
...
function create_data_dir()
	...
	if not System.doesDirExist("data/tetrinomi") then
		System.createDirectory("data/tetrinomi")
	end
end
...
function loading_screen(msg)
	...
	if msg then
		Font.print(fnt_main, 20, 20, "LOADING " .. msg, Color.new(255, 255, 255))
	else
...
-- debug function
if DEBUG_MODE then
	handle = System.openFile("data/tetris_debug.txt", FCREATE)
