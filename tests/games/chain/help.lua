...
-- load background
local img_background = Graphics.loadImage("assets/bg.png")
local img_touch = Graphics.loadImage("assets/touch.png")
local img_help = Graphics.loadImage("assets/help_mechanism.png")
