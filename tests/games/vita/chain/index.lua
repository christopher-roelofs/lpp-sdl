...
-- loads
img_sfx = Graphics.loadImage("assets/sfx.png")
img_background = Graphics.loadImage("assets/bg.png")
img_button_1 = Graphics.loadImage("assets/button_1.png")
img_button_2 = Graphics.loadImage("assets/button_2.png")
img_button_3 = Graphics.loadImage("assets/button_3.png")
img_button_4 = Graphics.loadImage("assets/button_4.png")
