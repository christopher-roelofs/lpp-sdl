...
-- font
-- local fnt_main 	= Font.load("assets/xolonium.ttf")
local fnt_retro 	= Font.load("assets/fonts/Retroscape.ttf")

-- load images
local img_highscore_header 	= Graphics.loadImage("assets/img/highscore_header.png")
