...
MAINMENUBACKGROUND = Graphics.loadImage("graphics/mainmenu/main.png");
MAINMENU_LOGO = Graphics.loadImage("graphics/mainmenu/logo.png");
-- Plus the loading bar
LOADINGBAR = Graphics.loadImage("graphics/mainmenu/loadingbar.png");
