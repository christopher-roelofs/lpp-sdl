stage14back = Image.load("stage14/background.png")
...
streak = { health = 0 }
question = { }
question[1] = { quest = "20", answer = "ni juu" }
question[2] = { quest = "21", answer = "ni juu ichi" }
question[3] = { quest = "22", answer = "ni juu ni" }
question[4] = { quest = "23", answer = "ni juu san" }
question[5] = { quest = "24", answer = "ni juu shi" }
question[6] = { quest = "25", answer = "ni juu go" }
question[7] = { quest = "26", answer = "ni juu roku" }
question[8] = { quest = "27", answer = "ni juu nana" }
question[9] = { quest = "28", answer = "ni juu hachi" }
question[10] = { quest = "29", answer = "ni juu kyuu" }
question[11] = { quest = "30", answer = "san juu" }
question[12] = { quest = "31", answer = "san juu ichi" }
question[13] = { quest = "32", answer = "san juu ni" }
question[14] = { quest = "24 (alternative)", answer = "ni juu yon" }
question[15] = { quest = "27 (alternative)", answer = "ni juu shichi" }
question[16] = { quest = "29 (alternative)", answer = "ni juu ku" }
question[17] = { quest = "5 O'Clock", answer = "goji" }
question[18] = { quest = "A.M. (Morning)", answer = "gozen" }
question[19] = { quest = "P.M. (Afternoon)", answer = "gogo" }
question[20] = { quest = "6 A.M.", answer = "gozen rokuji" }
question[21] = { quest = "8 P.M.", answer = "gogo hachiji" }
question[22] = { quest = "What time is it now?", answer = "ima nanji desu ka" }
question[23] = { quest = "It is 10 A.M. now", answer = "ima gozen juuji desu" }
...
if pose ~= 23 and loopCount >= 0 and loopCount < 4 then 
screen:blit(200, 150, sprite, 0, 0, 0, 80, 92)
elseif loopCount >= 4 and loopCount < 8 and pose ~= 23 then 
screen:blit(200, 150, sprite, 0, 80, 0, 80, 92)
elseif loopCount >= 8 and loopCount < 12 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 160, 0, 80, 92)
elseif loopCount >= 12 and loopCount < 16 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 240, 0, 80, 92)
elseif loopCount >= 16 and loopCount < 20 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 320, 0, 80, 92)
elseif loopCount >= 20 and loopCount < 24 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92)
elseif loopCount >= 24 and loopCount < 28 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 0, 92, 80, 92)
elseif loopCount >= 28 and loopCount < 32 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 80, 92, 80, 92)
elseif loopCount >= 32 and loopCount < 36 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 160, 92, 80, 92)
elseif loopCount >= 36 and loopCount < 40 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 240, 92, 80, 92)
elseif loopCount >= 40 and loopCount < 44 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 320, 92, 80, 92)
elseif loopCount >= 44 and loopCount < 48 and pose ~= 23 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92) end
if pose ~= 23 and loopCount + 1 >= 48 then loopCount = 0 else loopCount = loopCount + 1 end


if pose == 23 then loopCount2 = loopCount2 + 1
...
if pose == 23 then victory = victory + 1
...
if qcount == 24 then qcount = qcount -23
RanNumber = math.random(#question)
for a = 1, 23 do
question[a].complete = 0
qcount = 1
