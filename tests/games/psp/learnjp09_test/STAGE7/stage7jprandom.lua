stage7back = Image.load("stage7/background.png")
Wav.load("stage7/sounds/namae.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "always", answer = "いつも" }
question[2] = { quest = "station", answer = "えき" }
question[3] = { quest = "car", answer = "くるま" }
question[4] = { quest = "name", answer = "なまえ" }
question[5] = { quest = "my name is...", answer = "わたしのなまえは" }
question[6] = { quest = "to", answer = "まで" }
question[7] = { quest = "suffix used for days of the week", answer = "ようび" }
question[8] = { quest = "Monday", answer = "げつようび" }
question[9] = { quest = "Tuesday", answer = "かようび" }
question[10] = { quest = "Wednesday", answer = "すいようび" }
question[11] = { quest = "farewell party?", answer = "そうべつかい" }
question[12] = { quest = "telephone", answer = "でんわ" }
question[13] = { quest = "a little bit/just a lil", answer = "ちょっと" }
question[14] = { quest = "wait", answer = "まって" }
question[15] = { quest = "Mr. Tanaka's farewell party is Monday", answer = "たなかさんのそうべつかいはげつようびです" }
question[16] = { quest = "It is (isn't it)", answer = "そうですね" }
question[17] = { quest = "It is (I assure you!)", answer = "そうですよ" }
question[18] = { quest = "Please", answer = "ください" }
question[19] = { quest = "Please (to beg, request a service)", answer = "おねがいします" }
question[20] = { quest = "please wait a moment", answer = "ちょっとまってください" }
question[21] = { quest = "To Tokyo Station Please", answer = "とうきょうえきまでおねがいします" }
...
ifont:setStyle(1.0, black, nil_color, IntraFont.ALIGN_CENTER);
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[5].answer then
...
--elseif name == question[RanNumber].answer and question[RanNumber].answer == question[5].answer and gomenwav == 5 then
