stage3back = Image.load("stage3/background.png")
...
streak = { health = 0 }
question = { }
question[1] = { quest = "mother", answer = "おかあさん" }
question[2] = { quest = "father", answer = "おとうさん" }
question[3] = { quest = "older brother", answer = "おにいさん" }
question[4] = { quest = "older sister", answer = "おねえさん" }
question[5] = { quest = "uncle", answer = "おじさん" }
question[6] = { quest = "grandfather", answer = "おじいさん" }
question[7] = { quest = "grandmother", answer = "おばあさん" }
question[8] = { quest = "scary", answer = "こわい" }
question[9] = { quest = "dog", answer = "いぬ" }
question[10] = { quest = "cat", answer = "ねこ" }
question[11] = { quest = "bird", answer = "とり" }
question[12] = { quest = "what is it?", answer = "なんですか" }
question[13] = { quest = "good morning", answer = "おはようございます" }
question[14] = { quest = "dream", answer = "ゆめ" }
question[15] = { quest = "bank", answer = "ぎんこう" }
question[16] = { quest = "school", answer = "がっこう" }
question[17] = { quest = "thank you", answer = "ありがとう" }
question[18] = { quest = "Let's Eat; Bon Appetit (said before meals)", answer = "いただきます" }
question[19] = { quest = "thank you for the meal (said after meals)", answer = "ごちそうさまでした" }
question[20] = { quest = "I'm Sorry (forgive me)", answer = "ごめんなさい" }
question[21] = { quest = "farewell", answer = "さよなら" }
