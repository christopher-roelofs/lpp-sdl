stage1back = Image.load("stage1/background.png")
grasslayer = Image.load("stage1/grassyanime.png") 
Wav.load("stage1/sounds/oyasumi.wav", 1)
Wav.load("stage1/sounds/hai.wav", 2)
Wav.load("stage1/sounds/doushitano.wav", 3)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "yes", answer = "はい" }
question[2] = { quest = "no", answer = "いいえ" }
question[3] = { quest = "maybe", answer = "たぶん" }
question[4] = { quest = "Good Afternoon", answer = "こんにちは" }
question[5] = { quest = "Good Evening", answer = "こんばんは" }
question[6] = { quest = "Good Night", answer = "おやすみなさい" }
question[7] = { quest = "beautiful", answer = "すてき" }
question[8] = { quest = "what?", answer = "なに" }
question[9] = { quest = "tomorrow", answer = "あした" }
question[10] = { quest = "yesterday", answer = "きのう" }
question[11] = { quest = "key", answer = "かぎ" }
question[12] = { quest = "paper", answer = "かみ" }
question[13] = { quest = "hot", answer = "あつい" }
question[14] = { quest = "cold", answer = "さむい" }
question[15] = { quest = "this", answer = "これ" }
question[16] = { quest = "that", answer = "あの" }
question[17] = { quest = "over there", answer = "あそこ" }
question[18] = { quest = "Dragon", answer = "りゅう" }
question[19] = { quest = "Cherry Blossom", answer = "さくら" }
question[20] = { quest = "What's the matter?", answer = "どうしたの" }
question[21] = { quest = "See you later", answer = "じゃまた" }
...
ifont:setStyle(1.0, white, green2, IntraFont.ALIGN_CENTER);
...
screen:blit(0, 0, stage1back)

	 
	 if grasscount >= 0 and grasscount < 6 then 
    screen:blit(0, 194, grasslayer, 0, 0, 0, 480, 78)  
elseif grasscount >= 6 and grasscount < 12 then 
    screen:blit(0, 194, grasslayer, 0, 0, 78, 480, 78)   
elseif grasscount >= 12 and grasscount < 18 then
    screen:blit(0, 194, grasslayer, 0, 0, 156, 480, 78)  
elseif grasscount >= 18 and grasscount < 24 then
     screen:blit(0, 194, grasslayer, 0, 0, 234, 480, 78) 
elseif grasscount >= 24 and grasscount < 30 then
     screen:blit(0, 194, grasslayer, 0, 0, 312, 480, 78) 
 end
if grasscount + 1 >= 30 then grasscount = 0 else grasscount = grasscount + 1 end
...
loopCount2 = loopCount2 - 40
    ...
    if grasscount2 >= 0 and grasscount2 < 6 then 
     screen:blit(207, 220, grasslayer, 0, 0, 390, 67, 52)
elseif grasscount2 >= 6 and grasscount2 < 12 then 
	screen:blit(207, 216, grasslayer, 0, 67, 390, 67, 56)
elseif grasscount2 >= 12 and grasscount2 < 18 then
    screen:blit(207, 215, grasslayer, 0, 134, 390, 67, 57)
elseif grasscount2 >= 18 and grasscount2 < 24 then
    screen:blit(207, 214, grasslayer, 0, 201, 390, 67, 58)
elseif grasscount2 >= 24 and grasscount2 < 30 then
    screen:blit(207, 219, grasslayer, 0, 268, 390, 67, 53)
 end
if grasscount2 + 1 >= 30 then grasscount2 = 0 else grasscount2 = grasscount2 + 1 end
...
if answer == 1 then
ifont:print(240, 60, "" .. question[RanNumber].answer);
streak.health = 0
pose = 0
reset = 1
qcount = 1
...
if name == question[RanNumber].answer and name ~= question[1].answer and name ~= question[6].answer and name ~= question[20].answer  then
...
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[1].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
question[1].complete = 1
qcount = qcount + 1
Wav.play(false, 2)
streak.health = streak.health + 1
pose = pose + 1
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[6].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
question[6].complete = 1
qcount = qcount + 1
Wav.play(false, 1)
streak.health = streak.health + 1
pose = pose + 1
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[20].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
question[20].complete = 1
qcount = qcount + 1
Wav.play(false, 3)
streak.health = streak.health + 1
pose = pose + 1
