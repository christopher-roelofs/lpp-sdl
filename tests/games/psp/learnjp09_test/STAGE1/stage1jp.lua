...
mode2ka9 = 1
mode2ka10 = 1
if name == question[qcount].answer and name ~= question[1].answer and name ~= question[6].answer and name ~= question[20].answer  then
...
elseif name == question[1].answer and gomenwav == 1 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[6].answer and gomenwav == 6 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[20].answer and gomenwav == 20 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
if qcount == 22 then qcount = qcount -21
gomenwav = 1
end
