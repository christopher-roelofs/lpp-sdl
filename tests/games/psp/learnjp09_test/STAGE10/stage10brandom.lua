stage10back = Image.load("stage10/background.png")
...
streak = { health = 0 }
question = { }
question[1] = { quest = "left", answer = "hidari" }
question[2] = { quest = "right", answer = "migi" }
question[3] = { quest = "front", answer = "mae" }
question[4] = { quest = "back", answer = "ushiro" }
question[5] = { quest = "in front of", answer = "no mae" }
question[6] = { quest = "to the left of", answer = "no hidari" }
question[7] = { quest = "Excuse me where is the flower shop?", answer = "sumimasen hanaya wa doko desu ka" }
question[8] = { quest = "it's to the right of the bakery", answer = "panya no migi desu" }
question[9] = { quest = "It's behind that building", answer = "ano tatemono no ushiro desu" }
question[10] = { quest = "now", answer = "ima" }
question[11] = { quest = "airport", answer = "kuukou" }
question[12] = { quest = "Hours", answer = "jikan" }
question[13] = { quest = "How many hours", answer = "nanjikan" }
question[14] = { quest = "What Time", answer = "nanji" }
question[15] = { quest = "What time is it now", answer = "ima nanji desu ka" }
question[16] = { quest = "near", answer = "chikai" }
question[17] = { quest = "far", answer = "tooi" }
question[18] = { quest = "from", answer = "kara" }
question[19] = { quest = "here", answer = "koko" }
question[20] = { quest = "is it far from here?", answer = "koko kara tooi desu ka" }
question[21] = { quest = "is your house nearby?", answer = "anata no uchi wa chikai desu ka" }
question[22] = { quest = "From School to the Airport, how many hours is it?", answer = "gakko kara kuukou made nanjikan desu ka" }
...
if pose ~= 22 and loopCount >= 0 and loopCount < 4 then 
screen:blit(200, 150, sprite, 0, 0, 0, 80, 92)
elseif loopCount >= 4 and loopCount < 8 and pose ~= 22 then 
screen:blit(200, 150, sprite, 0, 80, 0, 80, 92)
elseif loopCount >= 8 and loopCount < 12 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 160, 0, 80, 92)
elseif loopCount >= 12 and loopCount < 16 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 240, 0, 80, 92)
elseif loopCount >= 16 and loopCount < 20 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 320, 0, 80, 92)
elseif loopCount >= 20 and loopCount < 24 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92)
elseif loopCount >= 24 and loopCount < 28 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 0, 92, 80, 92)
elseif loopCount >= 28 and loopCount < 32 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 80, 92, 80, 92)
elseif loopCount >= 32 and loopCount < 36 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 160, 92, 80, 92)
elseif loopCount >= 36 and loopCount < 40 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 240, 92, 80, 92)
elseif loopCount >= 40 and loopCount < 44 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 320, 92, 80, 92)
elseif loopCount >= 44 and loopCount < 48 and pose ~= 22 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92) end
if pose ~= 22 and loopCount + 1 >= 48 then loopCount = 0 else loopCount = loopCount + 1 end


if pose == 22 then loopCount2 = loopCount2 + 1
...
if pose == 22 then victory = victory + 1
...
if bgm == 1 then bgm = bgm + 1
elseif bgm == 3 then bgm = 2
end
]]
...
if answer == 1 then
--printCentered(55,"" .. question[RanNumber].answer,lightyellow)
font:setStyle(0.5, lightyellow, transparent, IntraFont.ALIGN_CENTER);
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer then
