stage4back = Image.load("stage4/background.png")
Mp3.load("stage4/sounds/honto.mp3", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "Let's Go", answer = "いきましょう" }
question[2] = { quest = "shopping", answer = "かいもの" }
question[3] = { quest = "amazing", answer = "すごい" }
question[4] = { quest = "weather", answer = "てんき" }
question[5] = { quest = "good", answer = "いい" }
question[6] = { quest = "good weather", answer = "いいてんき" }
question[7] = { quest = "my, mine", answer = "わたしの" }
question[8] = { quest = "your", answer = "あなたの" }
question[9] = { quest = "my dog", answer = "わたしのいぬ" }
question[10] = { quest = "your cat is cute", answer = "あなたのねこはかわいいです" }
question[11] = { quest = "book", answer = "ほん" }
question[12] = { quest = "bread", answer = "ぱん" }
question[13] = { quest = "flower", answer = "はな" }
question[14] = { quest = "suffix used for stores", answer = "や" }
question[15] = { quest = "bookstore", answer = "ほんや" }
question[16] = { quest = "breadstore (bakery)", answer = "ぱんや" }
question[17] = { quest = "flower shop", answer = "はなや" }
question[18] = { quest = "is that so?", answer = "そうですか" }
question[19] = { quest = "really?", answer = "ほんとうに" }
question[20] = { quest = "yes really", answer = "はいほんとう" }
question[21] = { quest = "finish; The End", answer = "おわり" }
...
--ifont:print(240, 103, ""..name);
--ifont:setStyle(1.0, white, green2, IntraFont.ALIGN_CENTER);

if answer == 1 then
ifont:setStyle(1.0, white, green2, IntraFont.ALIGN_CENTER);
ifont:print(240, 55, "" .. question[RanNumber].answer);
ifont:setStyle(1.0, white, green2, IntraFont.ALIGN_CENTER);
streak.health = 0
pose = 0
reset = 1
...
font:setStyle(0.5, lightyellow, nil_color, IntraFont.ALIGN_LEFT)
...
font:setStyle(0.5, black, nil_color, IntraFont.ALIGN_CENTER);
...
if name == question[RanNumber].answer and name ~= question[20].answer then
