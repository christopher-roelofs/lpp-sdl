stage9back = Image.load("stage9/background.png")
Wav.load("stage9/sounds/minaarigato.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "everybody", answer = "みんな" }
question[2] = { quest = "Saturday", answer = "どようび" }
question[3] = { quest = "Sunday", answer = "にちようび" }
question[4] = { quest = "when", answer = "いつ" }
question[5] = { quest = "was", answer = "でした" }
question[6] = { quest = "ceremony", answer = "しき" }
question[7] = { quest = "marriage", answer = "けっこん" }
question[8] = { quest = "Marriage / Wedding ceremony", answer = "けっこんしき" }
question[9] = { quest = "let me see, well, er....", answer = "ええと" }
question[10] = { quest = "When was Yumi san's Wedding Ceremony?", answer = "ゆみさんのけっこんしきはいつでしたか" }
question[11] = { quest = "um... It was Saturday", answer = "ええと、どようびでした" }
question[12] = { quest = "healty/fine", answer = "げんき" }
question[13] = { quest = "(prefix used when referring to others)", answer = "お" }
question[14] = { quest = "How are you?/are you well?", answer = "おげんきですか" }
question[15] = { quest = "Yes I'm fine", answer = "はいげんきです" }
question[16] = { quest = "birthday", answer = "たんじょうび" }
question[17] = { quest = "when is your birthday?", answer = "おたんじょうびはいつですか" }
question[18] = { quest = "My birthday is tomorrow", answer = "わたしのたんじょうびはあしたです" }
question[19] = { quest = "Happy Birthday (formal)", answer = "おたんじょうびおめでとうございます" }
question[20] = { quest = "Happy Birthday (casual)", answer = "たんじょうびおめでとう" }
question[21] = { quest = "Thank You Everybody", answer = "みんなありがとう" }
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[21].answer then
