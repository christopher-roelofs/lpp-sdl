...
streak = { health = 0 }
question = { }
question[1] = { quest = "Mail", answer = "メール" }
question[2] = { quest = "Drama", answer = "ドラマ" }
question[3] = { quest = "Radio", answer = "ラジオ" }
question[4] = { quest = "animation", answer = "アニメーション" }
question[5] = { quest = "Sailor Moon", answer = "セーラームーン" }
question[6] = { quest = "One Piece", answer = "ワンピース" }
question[7] = { quest = "Computer", answer = "コンピューター" }
question[8] = { quest = "Game", answer = "ゲーム" }
question[9] = { quest = "TV", answer = "テレビ" }
question[10] = { quest = "Basketball", answer = "バスケットボール" }
question[11] = { quest = "Label", answer = "レーベル" }
question[12] = { quest = "Mike Tyson", answer = "マイク・タイソ\ン" }
question[13] = { quest = "Final Fantasy", answer = "ファイナルファンタジー" }
question[14] = { quest = "tobacco", answer = "タバコ" }
question[15] = { quest = "Street Fighter", answer = "ストリートファイター" }
question[16] = { quest = "Normal", answer = "ノーマル" }
question[17] = { quest = "Chocolate Disco", answer = "チョコレイト・ディスコ" }
question[18] = { quest = "Gate Keeper", answer = "ゲートキーパー" }
question[19] = { quest = "Gate Keepers", answer = "ゲートキーパーズ" }
question[20] = { quest = "Comment", answer = "コメント" }
question[21] = { quest = "Super Puzzle Fighter II Turbo", answer = "スーパーパズルファイターⅡターボ" }
...
ifont:setStyle(1.0, white, black, IntraFont.ALIGN_CENTER);
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and mode2ka10 ~= 9 and mode2 == 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and mode2ka10 ~= 9 and mode2 == 2
then name = name .. kata[77]
mode2ka10 = mode2ka10 + 1
mode2ka = 1
mode2ka2 = 1
mode2ka3 = 1
...
--printCentered(130,"Correct",black)
...
elseif name == question[5].answer then
...
name = ""
screen.waitVblankStart(70)
elseif name == question[15].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[13].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[17].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[16].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[21].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
