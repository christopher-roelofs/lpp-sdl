stage2back = Image.load("stage2/background.png")
Wav.load("stage2/sounds/demo.wav", 1)
Wav.load("stage2/sounds/dare.wav", 2)
Wav.load("stage2/sounds/mendokuse.wav", 3)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "teacher", answer = "せんせい" }
question[2] = { quest = "doctor", answer = "いしゃ" }
question[3] = { quest = "writer", answer = "さっか" }
question[4] = { quest = "reporter", answer = "きしゃ" }
question[5] = { quest = "But...", answer = "でも" }
question[6] = { quest = "you", answer = "あなた" }
question[7] = { quest = "I", answer = "わたし" }
question[8] = { quest = "A Question Marker", answer = "か" }
question[9] = { quest = "A Topic Marker", answer = "は" }
question[10] = { quest = "is; am; are", answer = "です" }
question[11] = { quest = "person", answer = "ひと" }
question[12] = { quest = "that person", answer = "あのひと" }
question[13] = { quest = "who", answer = "だれ" }
question[14] = { quest = "who is that person?", answer = "あのひとはだれですか" }
question[15] = { quest = "he's a teacher", answer = "せんせいです" }
question[16] = { quest = "she's a reporter", answer = "きしゃです" }
question[17] = { quest = "building", answer = "たてもの" }
question[18] = { quest = "Excuse me", answer = "すみません" }
question[19] = { quest = "cute", answer = "かわいい" }
question[20] = { quest = "what a drag (It's Troublesome)", answer = "めんどくせ" }
question[21] = { quest = "Congratulations", answer = "おめでとう" }
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[5].answer and name ~= question[13].answer and name ~= question[20].answer then
