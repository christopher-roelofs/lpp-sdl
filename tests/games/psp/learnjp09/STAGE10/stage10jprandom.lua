...
streak = { health = 0 }
question = { }
question[1] = { quest = "left", answer = "ひだり" }
question[2] = { quest = "right", answer = "みぎ" }
question[3] = { quest = "front", answer = "まえ" }
question[4] = { quest = "back", answer = "うしろ" }
question[5] = { quest = "in front of", answer = "のまえ" }
question[6] = { quest = "to the left of", answer = "のひだり" }
question[7] = { quest = "Excuse me, where is the flower shop?", answer = "すみません、はなやはどこですか" }
question[8] = { quest = "it's to the right of the bakery", answer = "ぱんやのみぎです" }
question[9] = { quest = "It's behind that building", answer = "あのたてもののうしろです" }
question[10] = { quest = "now", answer = "いま" }
question[11] = { quest = "airport", answer = "くうこう" }
question[12] = { quest = "Hours", answer = "じかん" }
question[13] = { quest = "How many hours", answer = "なんじかん" }
question[14] = { quest = "What Time", answer = "なんじ" }
question[15] = { quest = "What time is it now", answer = "いまなんじですか" }
question[16] = { quest = "near", answer = "ちかい" }
question[17] = { quest = "far", answer = "とおい" }
question[18] = { quest = "from", answer = "から" }
question[19] = { quest = "here", answer = "ここ" }
question[20] = { quest = "is it far from here?", answer = "ここからとおいですか" }
question[21] = { quest = "is your house nearby?", answer = "あなたのうちはちかいですか" }
question[22] = { quest = "From School to the Airport, how many hours is it?", answer = "がっこうからくうこうまで、なんじかんですか" }
