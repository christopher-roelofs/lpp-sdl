stage6back = Image.load("stage6/background.png")
Mp3.load("stage6/sounds/weezy.mp3", 1)
Wav.load("stage3/sounds/gomennasai.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "where", answer = "どこ" }
question[2] = { quest = "friend", answer = "ともだち" }
question[3] = { quest = "safe; O.K.", answer = "だいじょうぶ" }
question[4] = { quest = "understanding", answer = "わかり" }
question[5] = { quest = "fool", answer = "あほう" }
question[6] = { quest = "idiot", answer = "ばか" }
question[7] = { quest = "your friend is a fool", answer = "あなたのともだちはあほうです" }
question[8] = { quest = "none; aint", answer = "ない" }
question[9] = { quest = "I understand", answer = "わかります" }
question[10] = { quest = "I don't understand", answer = "わかりません" }
question[11] = { quest = "I don't know", answer = "わからない" }
question[12] = { quest = "Excuse me, where is the bank?", answer = "すみません、ぎんこうはどこですか" }
question[13] = { quest = "I'm sorry, I don't know", answer = "ごめんなさい、わからない" }
question[14] = { quest = "It's okay. You're an idiot", answer = "だいじょうぶ。あなたはばかです" }
question[15] = { quest = "Mother, are you ok?", answer = "おかあさん、だいじょうぶですか" }
question[16] = { quest = "A Subject Marker", answer = "が" }
question[17] = { quest = "Japan", answer = "にほん" }
question[18] = { quest = "A little; Small Quantity", answer = "すこし" }
question[19] = { quest = "Do you understand Japanese?", answer = "あなたはにほんごがわかりますか" }
question[20] = { quest = "I understand Japanese a little", answer = "にほんごがすこしわかります" }
question[21] = { quest = "see you tomorrow", answer = "またあした" }
...
ifont:setStyle(1.0, white, blue, IntraFont.ALIGN_CENTER);
ifont:print(1, 1, "");
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[13].answer then
