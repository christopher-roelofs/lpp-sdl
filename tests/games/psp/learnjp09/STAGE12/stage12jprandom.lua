stage12back = Image.load("stage12/background.png")
...
streak = { health = 0 }
question = { }
question[1] = { quest = "train", answer = "でんしゃ" }
question[2] = { quest = "Bus", answer = "バス" }
question[3] = { quest = "hurry", answer = "はやく" }
question[4] = { quest = "hey", answer = "おい" }
question[5] = { quest = "hey tomo, hurry up", answer = "おいとも、はやく" }
question[6] = { quest = "about (approximately)", answer = "ぐらい" }
question[7] = { quest = "tall; high", answer = "たかい" }
question[8] = { quest = "chair", answer = "いす" }
question[9] = { quest = "I'm Leaving", answer = "いってきます" }
question[10] = { quest = "I'm Home", answer = "ただいま" }
question[11] = { quest = "why, why not?", answer = "どうして" }
question[12] = { quest = "by; in; with;", answer = "で" }
question[13] = { quest = "What day is today", answer = "きょうはなんようびですか" }
question[14] = { quest = "Today is Friday", answer = "きょうはきんようびです" }
question[15] = { quest = "that building is tall isn't it?", answer = "あのたてものはたかいですね" }
question[16] = { quest = "from Tokyo to Osaka, how many hours is it?", answer = "とうきょうからおおさかまで、なんじかんですか" }
question[17] = { quest = "about 2 hours", answer = "にじかんぐらい" }
question[18] = { quest = "by bus how many hours is it?", answer = "バスでなんじかんですか" }
question[19] = { quest = "about 3 hours", answer = "さんじかんぐらい" }
question[20] = { quest = "is it near from the school", answer = "がっこうからちかいですか" }
question[21] = { quest = "yes it's near. It is about 1 hour by train", answer = "はいちかいです。でんしゃでいちじかんぐらいです" }
