stage8back = Image.load("stage8/background.png")
Wav.load("stage8/sounds/itai.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "Thursday", answer = "もくようび" }
question[2] = { quest = "Friday", answer = "きんようび" }
question[3] = { quest = "light", answer = "ひかり" }
question[4] = { quest = "big", answer = "おおきい" }
question[5] = { quest = "small", answer = "ちいさい" }
question[6] = { quest = "liking, fondness", answer = "すき" }
question[7] = { quest = "love, to like very much", answer = "だいすき" }
question[8] = { quest = "dislike", answer = "きらい" }
question[9] = { quest = "very dislikable, Hate", answer = "だいきらい" }
question[10] = { quest = "Big (to describe something)", answer = "おおきな" }
question[11] = { quest = "Big Dream", answer = "おおきなゆめ" }
question[12] = { quest = "your dog is big", answer = "あなたのいぬはおおきいです" }
question[13] = { quest = "I like Big cats", answer = "おおきなねこがすきです" }
question[14] = { quest = "house, home", answer = "うち" }
question[15] = { quest = "my house is small", answer = "わたしのうちはちいさいです" }
question[16] = { quest = "together", answer = "いっしょに" }
question[17] = { quest = "small (to describe something)", answer = "ちいさな" }
question[18] = { quest = "painful, hurts", answer = "いたい" }
question[19] = { quest = "head", answer = "あたま" }
question[20] = { quest = "My Head Hurts", answer = "わたしのあたまがいたいです" }
question[21] = { quest = "let's go together", answer = "いっしょにいきましょう" }
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[18].answer then
...
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[18].answer then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
