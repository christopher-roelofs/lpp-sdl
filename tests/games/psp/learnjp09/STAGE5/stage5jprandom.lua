stage5back = Image.load("stage5/background.png")
Wav.load("stage5/sounds/nanikore.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "cool (stylish)", answer = "かっこいい" }
question[2] = { quest = "today", answer = "きょう" }
question[3] = { quest = "bad", answer = "わるい" }
question[4] = { quest = "France", answer = "フランス" }
question[5] = { quest = "nationality", answer = "じん" }
question[6] = { quest = "language", answer = "ご" }
question[7] = { quest = "French (person)", answer = "フランスじん" }
question[8] = { quest = "french language", answer = "フランスご" }
question[9] = { quest = "Germany", answer = "ドイツ" }
question[10] = { quest = "America", answer = "アメリカ" }
question[11] = { quest = "Canada", answer = "カナダ" }
question[12] = { quest = "of; for", answer = "の" }
question[13] = { quest = "person (polite)", answer = "かた" }
question[14] = { quest = "Person of America", answer = "アメリカのかた" }
question[15] = { quest = "are you Canadian?", answer = "あなたはカナダじんですか" }
question[16] = { quest = "no, I'm American", answer = "いいえ、わたしはアメリカじんです" }
question[17] = { quest = "this (thing)", answer = "この" }
question[18] = { quest = "this book is mine", answer = "このほんはわたしのです" }
question[19] = { quest = "this is bad", answer = "これはわるいです" }
question[20] = { quest = "what's this?", answer = "なにこれ" }
question[21] = { quest = "today is cold", answer = "きょうはさむいです" }
