stage15back = Image.load("stage15/background.png")
bganimate = Image.load("stage15/002.png")
Ogg.load("stage15/sounds/sailormogg.ogg", 0)
Ogg.load("stage15/sounds/sf2.ogg", 1)
Mp3.load("stage15/sounds/ff8.mp3", 0)
Mp3.load("stage15/sounds/choco.mp3", 1)
Wav.load("stage15/sounds/nomaru.wav", 2)
Wav.load("stage15/sounds/spf2x.wav", 1)
...
streak = { health = 0 }
question = { }
question[1] = { quest = "Mail", answer = "meeru" }
question[2] = { quest = "Drama", answer = "dorama" }
question[3] = { quest = "Radio", answer = "rajio" }
question[4] = { quest = "animation", answer = "animeeshon" }
question[5] = { quest = "Sailor Moon", answer = "seeraa muun" }
question[6] = { quest = "One Piece", answer = "wan piisu" }
question[7] = { quest = "Computer", answer = "konpyuutaa" }
question[8] = { quest = "Game", answer = "geemu" }
question[9] = { quest = "TV", answer = "terebi" }
question[10] = { quest = "Basketball", answer = "basukettobooru" }
question[11] = { quest = "Label", answer = "reeberu" }
question[12] = { quest = "Mike Tyson", answer = "maiku taison" }
question[13] = { quest = "Final Fantasy", answer = "fainaru fantajii" }
question[14] = { quest = "tobacco", answer = "tabako" }
question[15] = { quest = "Street Fighter", answer = "sutoriito faitaa" }
question[16] = { quest = "Normal", answer = "noomaru" }
question[17] = { quest = "Chocolate Disco", answer = "chokoreito disuko" }
question[18] = { quest = "Gate Keeper", answer = "geeto kiipaa" }
question[19] = { quest = "Gate Keepers", answer = "geeto kiipaazu" }
question[20] = { quest = "Comment", answer = "komento" }
question[21] = { quest = "Super Puzzle Fighter II Turbo", answer = "suupaa pazuru faitaa ii taabo" }
...
screen:clear()
   ...
   screen:blit(0, 0, stage15back) 

if animate >= 0 and animate < 81 then 
screen:blit(0, 0, bganimate)
end
if animate + 1 >= 161 then animate = 0 else animate = animate + 1 end
   
if mode2 == 1 then screen:blit(80, 120, dpad3, 0, 0, 0, 76, 78)
elseif mode2 >= 2 then screen:blit(80, 120, dpad3, 0, 76, 0, 76, 78)
end

if mode2 == 1 then screen:blit(20, 22, dpad3, 0, 101, 78, 95, 15)
elseif mode2 >= 2 then screen:blit(20, 22, dpad3, 0, 0, 78, 101, 18)
end

if mode2 == 1 then screen:blit(318, 115, dpad3, 0, 228, 0, 87, 87)
elseif mode2 >= 2 then screen:blit(318, 115, dpad3, 0, 315, 0, 87, 87)
end
	 

if pose ~= 21 and loopCount >= 0 and loopCount < 4 then 
screen:blit(200, 150, sprite, 0, 0, 0, 80, 92)
elseif loopCount >= 4 and loopCount < 8 and pose ~= 21 then 
screen:blit(200, 150, sprite, 0, 80, 0, 80, 92)
elseif loopCount >= 8 and loopCount < 12 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 160, 0, 80, 92)
elseif loopCount >= 12 and loopCount < 16 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 240, 0, 80, 92)
elseif loopCount >= 16 and loopCount < 20 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 320, 0, 80, 92)
elseif loopCount >= 20 and loopCount < 24 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92)
elseif loopCount >= 24 and loopCount < 28 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 0, 92, 80, 92)
elseif loopCount >= 28 and loopCount < 32 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 80, 92, 80, 92)
elseif loopCount >= 32 and loopCount < 36 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 160, 92, 80, 92)
elseif loopCount >= 36 and loopCount < 40 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 240, 92, 80, 92)
elseif loopCount >= 40 and loopCount < 44 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 320, 92, 80, 92)
elseif loopCount >= 44 and loopCount < 48 and pose ~= 21 then
screen:blit(200, 150, sprite, 0, 400, 0, 80, 92) end
if pose ~= 21 and loopCount + 1 >= 48 then loopCount = 0 else loopCount = loopCount + 1 end


if pose == 21 then loopCount2 = loopCount2 + 1
...
if randomnum == 1 and question[RanNumber].complete == 1 then
RanNumber = math.random(#question)
end


font:setStyle(0.5, midnightblue, nil_color, IntraFont.ALIGN_LEFT)
...
font:setStyle(0.5, midnightblue, nil_color, IntraFont.ALIGN_CENTER);
font:print(240, 80, question[RanNumber].quest)

font:setStyle(0.5, blue, nil_color, IntraFont.ALIGN_CENTER);
font:print(240, 106, ""..name);

font:setStyle(0.5, white, transparent, IntraFont.ALIGN_LEFT);
font:print(10, 260, "R+Triangle = Menu")
...
dofile("Cheatjprandom.LUA")

if answer == 1 then
--printCentered(55,"" .. question[RanNumber].answer,black)
font:setStyle(0.5, black, transparent, IntraFont.ALIGN_CENTER);
font:print(240, 60, "" .. question[RanNumber].answer)
streak.health = 0
pose = 0
qcount = 1
for a = 1, 21 do
question[a].complete = 0
end
end
...
mode2ka8 = 1
mode2ka9 = 1
if name == question[RanNumber].answer and name ~= question[15].answer and name ~= question[5].answer and name ~= question[13].answer and name ~= question[16].answer and name ~= question[17].answer and name ~= question[21].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
question[RanNumber].complete = 1
qcount = qcount + 1
streak.health = streak.health + 1
pose = pose + 1
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[5].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[15].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[13].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[17].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[16].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[RanNumber].answer and question[RanNumber].answer == question[21].answer then
--printCentered(130,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
if pose == 21 then victory = victory + 1
...
if pad:square() and oldpad:square() ~=pad:square() and mode2 == 1 and currentLetter5 ~= 7 and pad:square() ~= pad:r()
...
if pad:l() and oldpad:l() ~=pad:l() and mode2 <= 1
then name = string.sub(name, 1, string.len(name) - 1)
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 ~= 11 
then name = name .. longvowel[1]
currentLetter9 = currentLetter9 + 1
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
currentLetter4 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 == 3
then name = string.sub(name, 1, string.len(name) - 2)
name = name .. longvowel[2]
currentLetter9 = currentLetter9 + 1
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 == 5
then name = string.sub(name, 1, string.len(name) - 2)
name = name .. longvowel[3]
currentLetter9 = currentLetter9 + 1
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 == 7
then name = string.sub(name, 1, string.len(name) - 2)
name = name .. longvowel[4]
currentLetter9 = currentLetter9 + 1
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 == 9
then name = string.sub(name, 1, string.len(name) - 2)
name = name .. longvowel[5]
currentLetter9 = currentLetter9 + 1
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
...
if pad:r() and pad:square() ~= oldpad:square() and pad:r() ~= oldpad:square() and currentLetter9 == 11
then name = string.sub(name, 1, string.len(name) - 2)
name = name .. longvowel[1]
currentLetter9 = currentLetter9 - 9
currentLetter = 1
currentLetter2 = 1
currentLetter3 = 1
currentLetter4 = 1
...
if pad:analogX() > 120 and oldpad:analogX() ~=pad:analogX() and pad:analogX() ~=pad:analogY() and mode2 == 1 and spacebar < 1
then name = name .. space[2]
spacebar = spacebar + 1
currentLetter = 1
currentLetter2 = 1
