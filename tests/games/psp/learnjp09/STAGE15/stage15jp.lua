...
mode2ka8 = 1
mode2ka9 = 1
if name == question[qcount].answer and name ~= question[15].answer and name ~= question[5].answer and name ~= question[13].answer and name ~= question[16].answer and name ~= question[17].answer and name ~= question[21].answer then
...
elseif name == question[5].answer and gomenwav == 5 then
...
name = ""
screen.waitVblankStart(70)
elseif name == question[15].answer and gomenwav == 15 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[13].answer and gomenwav == 13 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[17].answer and gomenwav == 17 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[16].answer and gomenwav == 16 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
...
name = ""
screen.waitVblankStart(70)
elseif name == question[21].answer and gomenwav == 21 then
--printCentered(120,"Correct",pink)
font:setStyle(0.5, pink, nil_color, IntraFont.ALIGN_CENTER)
font:print(240, 120, "Correct")
screen.flip()
