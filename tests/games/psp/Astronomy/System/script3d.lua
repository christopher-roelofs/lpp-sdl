...
cubeAxisRotations = make3DPoint(-1,-3,0)
...
rotateCube = function()
	...
	-- top
	theScene:drawLine(screenPoints[1].x, screenPoints[1].y, screenPoints[2].x, screenPoints[2].y, color.grey)
	theScene:drawLine(screenPoints[2].x, screenPoints[2].y, screenPoints[3].x, screenPoints[3].y, color.grey)
	theScene:drawLine(screenPoints[3].x, screenPoints[3].y, screenPoints[4].x, screenPoints[4].y, color.grey)
	theScene:drawLine(screenPoints[4].x, screenPoints[4].y, screenPoints[1].x, screenPoints[1].y, color.grey)
	-- bottom
	theScene:drawLine(screenPoints[5].x, screenPoints[5].y, screenPoints[6].x, screenPoints[6].y, color.grey)
	theScene:drawLine(screenPoints[6].x, screenPoints[6].y, screenPoints[7].x, screenPoints[7].y, color.grey)
	theScene:drawLine(screenPoints[7].x, screenPoints[7].y, screenPoints[8].x, screenPoints[8].y, color.grey)
	theScene:drawLine(screenPoints[8].x, screenPoints[8].y, screenPoints[5].x, screenPoints[5].y, color.grey)
	-- connecting bottom and top
	theScene:drawLine(screenPoints[1].x, screenPoints[1].y, screenPoints[5].x, screenPoints[5].y, color.grey)
	theScene:drawLine(screenPoints[2].x, screenPoints[2].y, screenPoints[6].x, screenPoints[6].y, color.grey)
	theScene:drawLine(screenPoints[3].x, screenPoints[3].y, screenPoints[7].x, screenPoints[7].y, color.grey)
	theScene:drawLine(screenPoints[4].x, screenPoints[4].y, screenPoints[8].x, screenPoints[8].y, color.grey)
	a1 = screenPoints[9].x 
	a2 = screenPoints[9].y
	a3 = screenPoints[10].x 
	a4 = screenPoints[10].y
	a5 = screenPoints[11].x 
	a6 = screenPoints[11].y
	a7 = screenPoints[12].x 
	a8 = screenPoints[12].y
end
...
zon = Image.load("pics/zon.png") 
aarde = Image.load("pics/earth.png") 
...
while not Controls.read():circle() do
	...
	rotateCube()
	-- display
	theScene:print(80, 262,"Inner Planets for date = "..jdvar[teller], color.white)	
	theScene:print(0,0,"Use arrows",color.red)
	theScene:print(0,10,"to rotate",color.red)
	screen:blit(0, 0, theScene)
	screen:blit(240,131, zon)
	screen:blit(a1,a2, aarde)
	screen:blit(a3,a4, aarde)
	screen:blit(a5,a6, aarde)
	screen:blit(a7,a8, aarde)

	pointsArray[9].x = mercx[teller]
	pointsArray[9].y = mercy[teller]
	pointsArray[9].z = mercz[teller]
	pointsArray[10].x = venux[teller]
	pointsArray[10].y = venuy[teller]
	pointsArray[10].z = venuz[teller]
	pointsArray[11].x = eartx[teller]
	pointsArray[11].y = earty[teller]
	pointsArray[11].z = eartz[teller]
	pointsArray[12].x = marsx[teller]
	pointsArray[12].y = marsy[teller]
	pointsArray[12].z = marsz[teller]


	screen.waitVblankStart()
	screen.flip()
	teller = teller + 1
	if teller >= 365 then teller = 1 end
end
