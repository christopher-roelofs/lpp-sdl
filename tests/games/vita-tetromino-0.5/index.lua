...
-- screen bg
background = Graphics.loadImage("assets/background.png")
battery_icon = Graphics.loadImage("assets/power.png")
control = Graphics.loadImage("assets/control.png")

-- font
main_font = Font.load("assets/xolonium.ttf")
...
function get_high_score()
    ...
    -- check if file exist
	if System.doesFileExist("data/tetrinomi/tetris_score") then
	    
	    -- open file
		local score_file = System.openFile("data/tetrinomi/tetris_score", FREAD)
...
function new_highscore(score)
	...
	if highscore >= score then
		...
		if System.doesFileExist("data/tetrinomi/tetris_score") then
			System.deleteFile("data/tetrinomi/tetris_score")
		end
	end
	
	-- create it a new highscore file
	local new_score_file = System.openFile("data/tetrinomi/tetris_score", FCREATE)
